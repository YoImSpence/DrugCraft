...
public class CheckersGUI {
    ...
    public CheckersGUI(DrugCraft plugin) {
        this.plugin = plugin;
    }

    public void openCheckersMenu(Player player) {
        Inventory inv = Bukkit.createInventory(null, 27, MiniMessage.miniMessage().deserialize(MessageUtils.getMessage("gui.games.checkers-title")));
        ...
        inv.setItem(13, createItem(Material.PAPER, "<#FFFF55>Move (e.g., 12-16)"));
